import type { CollapseProps, DefaultProps, MantineColor, MantineNumberSize, MantineShadow, MantineSize, MantineTheme, Sx, TableProps } from '@mantine/core';
import type { CSSProperties, ReactNode } from 'react';
export declare type DataTableColumnTextAlignment = 'left' | 'center' | 'right';
export declare type DataTableVerticalAlignment = 'top' | 'center' | 'bottom';
export declare type DataTableOuterBorderProps = {
    withBorder?: never;
    borderRadius?: never;
} | {
    /**
...
export declare type DataTableEmptyStateProps = {
    /**
...
export declare type DataTablePaginationProps = {
    page?: never;
    onPageChange?: never;
    totalRecords?: never;
...
export declare type DataTableSortStatus = {
    /**
...
export declare type DataTableSortProps = {
    sortStatus?: never;
...
export declare type DataTableSelectionProps<T> = {
...
export declare type DataTableContextMenuItemProps = ({
    /**
     * Unique item key
     */
    key: string;
...
export declare type DataTableContextMenuProps<T> = {
    /**
...
export declare type DataTableRowExpansionCollapseProps = Pick<CollapseProps, 'animateOpacity' | 'transitionDuration' | 'transitionTimingFunction'>;
export declare type DataTableRowExpansionProps<T> = {
    /**
...
} & Pick<TableProps, 'striped' | 'highlightOnHover' | 'horizontalSpacing' | 'verticalSpacing' | 'fontSize'> & Omit<DefaultProps<'root' | 'header' | 'pagination', CSSProperties>, 'unstyled'> & DataTableOuterBorderProps & DataTableEmptyStateProps & DataTablePaginationProps & DataTableSortProps & DataTableSelectionProps<T>;
//# sourceMappingURL=DataTable.props.d.ts.map